...
public class U8OrderUtils{
	...
	private static final String ORDER_URL = "http://192.168.18.9:8080/pay/getOrderID";
	 ...
	 * @return
	 */
	public static U8Order getOrder(PayParams data){
		...
		try{
			...
			String orderResult = U8HttpUtils.httpPost(ORDER_URL, params);
