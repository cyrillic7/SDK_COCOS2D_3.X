...
public class U8LoginUtils {
	...
	private static final String LOGIN_URL = "http://192.168.18.9:8080/user/loginServer";
	...
	public static U8Account login(){
		...
		try{
			...
			String loginResult = U8HttpUtils.httpPost(LOGIN_URL, params);
