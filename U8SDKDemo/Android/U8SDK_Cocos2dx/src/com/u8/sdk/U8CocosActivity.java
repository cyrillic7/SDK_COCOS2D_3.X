...
public class U8CocosActivity extends Cocos2dxActivity{
	...
	{
		int channelid = U8SDK.getInstance().getCurrChannel();
		Log.e("U8SDK", "getChannel ");
	...
	private PayParams parsePayParams(JSONObject json){
		...
		try{	
			...
			Log.v("orderid","orderid"+json.getString("orderID"));
		}catch(Exception e){
			e.printStackTrace();
		}
